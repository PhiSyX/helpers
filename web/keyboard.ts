...
// Voir https://www.w3.org/TR/uievents-key/

export const UI_KEYBOARDEVENT_KEYS: OBJECT<ARRAY<string>> = {
  special: [
...
export let allKeyboardKeys = Object.keys(UI_KEYBOARDEVENT_KEYS)
  .reduce(
    (acc, category) => [...acc, ...UI_KEYBOARDEVENT_KEYS[category]],
    [] as ARRAY<string>,
  );

export function isPrintableKey(e: KeyboardEvent) {
  return allKeyboardKeys.indexOf(e.key) === -1;
}
